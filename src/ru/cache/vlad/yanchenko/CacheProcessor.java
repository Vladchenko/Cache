...
//        }
        ...
        if (ramCache.getMapObjects() != null) {
            if (ramCache.getMapObjects().size() == 0) {
            ...
            for (Map.Entry<Object, Object> entrySet : hddCache.getMapFiles().entrySet()) {
                Object key = entrySet.getKey();
                Object value = entrySet.getValue();
     ...
     */
    public void setHddCache(HDDCache hddCache) {
     ...
     */
    public void setCacheFeeder(CacheFeeder cacheFeeder) {
