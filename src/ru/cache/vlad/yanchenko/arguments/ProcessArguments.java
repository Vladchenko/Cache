...
public class ProcessArguments {
    ...
    private Map<String, String> readArguments(String[] args) {

        // Delimiter that separates key from value in an antry.
...
//        // Reading a command line arguments to a respective map;
...
//        printArgs(arguments);
    ...
    private void processCachesSizes(Map<String, String> arguments) {
    ...
    private void processCacheKind(Map<String, String> arguments) {
...
//            repository.getLogger().info("");
    ...
    private void processAccompanyingArguments(Map<String, String> arguments) {
...
//            repository.getLogger().info("");
        ...
        /**
         * Defining a cache process running times, i.e. how many times a caching
         * process is to run.
         */
        try {
